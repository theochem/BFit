...
class KullbackLeiblerFitting:
    ...
    def _update_errors(self, coeffs, exps, c, iprint, iplot):
    ...
    def __call__(self, eps_coeff, eps_params, coeffs, fparams, iprint=False, iplot=False):
        r"""
        ...
        counter = 0
        while np.any(np.abs(fparams_i1 - fparams_i) > eps_params) and \
            ...
            counter = self._update_errors(coeffs_i1, fparams_i1, counter, iprint, iplot) + 1
