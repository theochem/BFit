...
def func(x):
    rho, grid, UGBS_List = be_rho, Be_grid, be_UGBS
...
def clenshaw_curtis(atomic_number, gridpoints1, gridpoints2):
    """
    This does not include two zeroes
    :param atomic_number:
    :param gridpoints1:
    :param gridpoints2:
    :return:
...
print(np.shape(clenshaw_curtis(4, 200, 300)))
...
print(total_density_cost_function(1, (be_UGBS, Be_grid, be_rho)))