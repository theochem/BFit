...
import numpy as np
from fitting.gbasis.gbasis import ContractedGaussianBasis, UGBSBasis
...
def test_UGBSBasis_be():
    ...
    expected = np.array([201995.358823884, 103156.238855453, 52680.4659115021, 26903.1860742975,
                         13739.0854166734, 7016.36109438299, 3583.15866840945, 1829.86962476550,
                         934.489134729211, 477.230689612032, 243.715119463182, 124.461944187287,
                         63.5609952513411, 32.4597220758638, 16.5767315800501, 8.46550778330153,
                         4.32321786011102, 2.20780762884063, 1.12749685157938, 0.57579706389046,
                         0.29405160495168, 0.15016809184547, 7.66887696879e-2, 3.91638950989e-2,
                         2.00004601138e-2])
